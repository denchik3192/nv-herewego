...
type ProductgridDocumentDataSlicesSlice = never;
...
interface SkaterDocumentData {
  ...
  /**
   * Photo Backgroung field in *Skater*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.foto_backgroung
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  foto_backgroung: prismic.ImageField<never>;
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.photo_foregraund
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  photo_foregraund: prismic.ImageField<never>;
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: skater.customizer_l
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  customizer_l: prismic.LinkField<
    string,
    string,
    unknown,
    prismic.FieldState,
...
export interface HeroSliceDefaultPrimary {
   ...
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.skate_deck_texture
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  skate_deck_texture: prismic.ImageField<never>;
...
export interface TextAndImageSliceDefaultPrimary {
   ...
   */
  theme: prismic.SelectField<"Blue" | "Orange" | "Navi" | "Lime">;
